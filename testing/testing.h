...
const std::vector<std::vector<std::vector<int>>> refs_test_images_gray_10_clusters{
...
const std::vector<std::vector<std::vector<int>>> refs_test_images_color_10_clusters{
